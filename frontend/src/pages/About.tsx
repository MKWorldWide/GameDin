        ...
        <Grid item xs={12}>
          <Paper sx={{ p: 3 }}>
            ...
            <Typography variant="body1" paragraph>
              GameDin is a social platform designed to connect gamers worldwide. We believe in creating meaningful connections through shared gaming experiences.
            </Typography>
            <Typography variant="h6" gutterBottom>
              What We Offer
            </Typography>
            <Typography variant="body1" paragraph>
              ...
              • Find gaming jobs and opportunities
